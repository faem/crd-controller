...
import (
	...
	crdcntrlrcomv1alpha1 "crd-controller/pkg/apis/crdcntrlr.com/v1alpha1"
	v1alpha1 "crd-controller/pkg/client/listers/crdcntrlr.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdcntrlrV1alpha1().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdcntrlrV1alpha1().Foos(namespace).Watch(options)
			},
		},
		&crdcntrlrcomv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdcntrlrcomv1alpha1.Foo{}, f.defaultInformer)
}
