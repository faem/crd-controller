...
type FakeFoos struct {
	Fake *FakeCrdcntrlrV1alpha1
	ns   string
}

var foosResource = schema.GroupVersionResource{Group: "crdcntrlr.com", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "crdcntrlr.com", Version: "v1alpha1", Kind: "Foo"}
